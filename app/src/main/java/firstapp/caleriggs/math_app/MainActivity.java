package firstapp.caleriggs.math_app;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calcButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                float total = Float.parseFloat(numberText.getText().toString());
                float totalCalc = dec * total;
                totalTextView.setText(String.valueOf(totalCalc));
